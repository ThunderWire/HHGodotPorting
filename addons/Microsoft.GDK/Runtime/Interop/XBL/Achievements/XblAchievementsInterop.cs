...
namespace GDK.XGamingRuntime.Interop
{
    internal static partial class XblInterop
    {
        ...
        [DllImport(XblThunkDllName, CallingConvention = CallingConvention.StdCall)]
        internal static extern XblFunctionContext XblAchievementsAddAchievementProgressChangeHandler(
            IntPtr xblContext,
        ...
        //) XBL_NOEXCEPT;
        [DllImport(XblThunkDllName, CallingConvention = CallingConvention.StdCall)]
        internal static extern void XblAchievementsRemoveAchievementProgressChangeHandler(
