...
namespace Unity.XGamingRuntime.Interop
{
    public static class Converters
    {
        ...
        public static Byte[] StringToNullTerminatedUTF8ByteArray(string str) => StringToNullTerminatedUTF8ByteArrayInternal(str, requiredByteArrayLength: -1);
        public static Byte[] StringToNullTerminatedUTF8ByteArray(string str, int requiredByteArrayLength) => StringToNullTerminatedUTF8ByteArrayInternal(str, requiredByteArrayLength);
