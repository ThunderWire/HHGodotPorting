...
namespace Unity.XGamingRuntime.Interop
{
    partial class XblInterop
    {
        ...
        //) XBL_NOEXCEPT;
        [DllImport(XblThunkDllName, CallingConvention = CallingConvention.StdCall)]
        internal static extern Int32 XblPrivacyCheckPermissionForAnonymousUserAsync(
            IntPtr xblContextHandle,
            XblPermission permissionToCheck,
        ...
        //) XBL_NOEXCEPT;
        [DllImport(XblThunkDllName, CallingConvention = CallingConvention.StdCall)]
        internal static extern Int32 XblPrivacyCheckPermissionForAnonymousUserResultSize(
            XAsyncBlockPtr async,
            out SizeT resultSizeInBytes);
        ...
        //) XBL_NOEXCEPT;
        [DllImport(XblThunkDllName, CallingConvention = CallingConvention.StdCall)]
        internal static extern Int32 XblPrivacyCheckPermissionForAnonymousUserResult(
            XAsyncBlockPtr async,
            SizeT bufferSize,
            IntPtr buffer,
